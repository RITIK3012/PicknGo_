                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="pickupLatitude" class="form-label">Latitude (e.g., 12.9716)</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="pickupLongitude" class="form-label">Longitude (e.g., 77.5946)</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="deliveryLatitude" class="form-label">Latitude (e.g., 12.9716)</label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="deliveryLongitude" class="form-label">Longitude (e.g., 77.5946)</label>
