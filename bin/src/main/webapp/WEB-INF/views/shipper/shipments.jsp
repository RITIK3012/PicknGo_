                                ...
                                <c:otherwise>
                                    <c:forEach items="${shipments}" var="shipment">
                                        <tr>
                                            ...
                                            <td>
                                                <fmt:formatDate value="${shipment.createdAt}" pattern="MMM dd, yyyy" />
                                            </td>
                                            <td>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row mb-3">
                                                                    <div class="col-md-6">
                                                                        <h6>Created Date:</h6>
                                                                        <p><fmt:formatDate value="${shipment.createdAt}" pattern="MMM dd, yyyy HH:mm" /></p>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <h6>Last Updated:</h6>
                                                                        <p><fmt:formatDate value="${shipment.updatedAt}" pattern="MMM dd, yyyy HH:mm" /></p>
                                                                    </div>
                                                                </div>
                                                                <div class="mb-3">
                                                                    <h6>Description:</h6>
