                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <c:choose>
                                    <c:when test="${not empty shipment.createdAt}">
                                        <fmt:parseDate value="${shipment.createdAt}" pattern="yyyy-MM-dd'T'HH:mm" var="parsedCreatedAt" type="both" />
                    ...
                    <div class="card-body">
                        ...
                        <c:if test="${shipment.pickupTime != null}">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <c:choose>
                                        <c:when test="${not empty shipment.pickupTime}">
                                            <fmt:parseDate value="${shipment.pickupTime}" pattern="yyyy-MM-dd'T'HH:mm" var="parsedPickupTime" type="both" />
                                            <fmt:formatDate value="${parsedPickupTime}" pattern="dd-MM-yyyy HH:mm" />
                                        </c:when>
                                        <c:otherwise>Not available</c:otherwise>
                                    </c:choose>
                                </div>
                        ...
                        <c:if test="${shipment.deliveryTime != null}">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <c:choose>
                                        <c:when test="${not empty shipment.deliveryTime}">
                                            <fmt:parseDate value="${shipment.deliveryTime}" pattern="yyyy-MM-dd'T'HH:mm" var="parsedDeliveryTime" type="both" />
                                            <fmt:formatDate value="${parsedDeliveryTime}" pattern="dd-MM-yyyy HH:mm" />
                                        </c:when>
                                        <c:otherwise>Not available</c:otherwise>
                                    </c:choose>
                                </div>
                                                ...
                                                <div class="d-flex w-100 justify-content-between align-items-center">
                                                    <div>
                                                        ...
                                                        <small>
                                                            Interest shown: 
                                                            <c:choose>
                                                                <c:when test="${not empty interest.createdAt}">
                                                                    <fmt:parseDate value="${interest.createdAt}" pattern="yyyy-MM-dd'T'HH:mm" var="parsedInterestTime" type="both" />
                                                                    <fmt:formatDate value="${parsedInterestTime}" pattern="dd-MM-yyyy HH:mm" />
                                                                </c:when>
                                                                <c:otherwise>Not available</c:otherwise>
                                                            </c:choose>
                                                        </small>
